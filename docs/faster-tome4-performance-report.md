...
> 历史报告：下文记录截至 0.2.1 的证据。当前 0.2.10 加入 [存档短编号](save-size-analysis.md)；此前 0.2.9 新增寻路优化、FBO/遮罩组合与聊天弱引用修复，且已完成真实地图测量，见 [0.2.9 报告](ai-performance.md)；各次后续保存/渲染验证见仓库 README 的版本链接。
